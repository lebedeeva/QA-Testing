 ...
 */
 ...
 console.log(`\nlast character in mySentence -> ${lasCharacter}`);  // s
 
 
 const mySentence2 = "Hello";
 ...
 const myResult4 = mySentence2.substring(-2, -4);    // (0, 0)   empty
 console.log(`\nmyResult4 -> ${myResult4}`);
 
 const myResult5 = mySentence2.substring(3, 1);    // (1, 3)  el
 console.log(`\nmyResult5 -> ${myResult5}`);
 ...
 const myResult6 = mySentence2.slice(1,3);   // (1,2)  el
 console.log(`\nmyResult6 -> ${myResult6}`);
 
 const myResult7 = mySentence2.slice(1);     //  starting at 1  ello
 console.log(`\nmyResult7 -> ${myResult7}`);
 
 
 const myResult8 = mySentence2.slice(-3,-1);  // (2,3)  ll
 console.log(`\nmyResult8 -> ${myResult8}`);
 ...
 const myResult9 = mySentence2.substr(2, 3);   // llo
 console.log(`\nmyResult9 -> ${myResult9}`);
